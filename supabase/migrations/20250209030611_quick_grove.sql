/*
  ...
  1. Changes
    - Remove problemas_ids, problemas_descricoes, servicos_ids, servicos_descricoes columns
    - Keep only observacoes field for all descriptions
  ...
  2. Structure
    ...
    - Single text field for all descriptions
